...
def genPDB(name_l, coord_l, topology):
    ...
    for n in range(len(name_l)):
        text.append(crdline.format(serial=n + 1, name=name_l[n], resname="SYS", x=coord_l[n][0], y=coord_l[n][1], z=coord_l[n][2], elem="".join(_ for _ in name_l[n] if not _.isdigit())))
    for n in range(len(name_l)):
